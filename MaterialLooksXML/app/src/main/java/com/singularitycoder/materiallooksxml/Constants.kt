...
object Constants {
    ...
    init {
        MaterialComponents.values().forEach { it: MaterialComponents -> materialComponentList.add(MaterialComponent(image = it.image, title = it.title, subtitle = it.subTitle, link = it.link)) }
    }
